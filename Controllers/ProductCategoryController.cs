...
namespace AdventureWorksSales.Controllers
{
    public class ProductCategoryController : Controller
    {
        ...
        {
            var res = _productCategoryService.GetAllProductCategories(pageIndex, pageSize);
            return View(res);
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductCategoryID,ModifiedDate,rowguid")] ProductCategory productCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductCategoryID,ModifiedDate,rowguid")] ProductCategory productCategory)
        {
